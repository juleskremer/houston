...
@Component({
  ...
  directives: [Alert, CORE_DIRECTIVES, FORM_DIRECTIVES],
...
export class TypeaheadDemo {
  ...
  private statesComplex:Array<any> = [
    ...
    {id: 24, name: 'Minnesota'}, {id: 25, name: 'Mississippi'}, {
      id: 26,
      name: 'Missouri'
    },
    ...
    {id: 30, name: 'New Hampshire'}, {id: 31, name: 'New Jersey'}, {
      id: 32,
      name: 'New Mexico'
    },
    ...
    {id: 36, name: 'Ohio'}, {id: 37, name: 'Oklahoma'}, {
      id: 38,
      name: 'Oregon'
    }, {id: 39, name: 'Pennsylvania'},
    {id: 40, name: 'Rhode Island'}, {id: 41, name: 'South Carolina'}, {
      id: 42,
      name: 'South Dakota'
    },
