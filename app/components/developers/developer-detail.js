System.register(['angular2/core', '../../services/developers/developer.service', 'angular2/router'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            DeveloperDetailComponent = (function () {
                function DeveloperDetailComponent(_router, _routeParams, _service) {
                ...
                DeveloperDetailComponent.prototype.onSelect = function (developer) {
                    this._router.navigate(['DeveloperEdit', { id: developer.gitID }]);
                };
                DeveloperDetailComponent.prototype.gotoDevelopers = function () {
                ...
                DeveloperDetailComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [router_1.Router, router_1.RouteParams, developer_service_1.DeveloperService])
                ], DeveloperDetailComponent);
                return DeveloperDetailComponent;
            })();
            exports_1("DeveloperDetailComponent", DeveloperDetailComponent);
        }
    }
});
